package com.mji.patientmonitor.webrtc;
...
//import
//import mji.tapia.com.service.SocketConnectionService;
...
public class WebRTCActivity extends AppCompatActivity {
    ...
    private String socketAddress = "http://13.230.235.178:3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // user set up
        String userName = new String("andy");
        String key = new String("012345");
        //user = new User(userName, key);

        mSocket.connect();

        //String privateKey = preferenceUtils.getPrivateKey();
        //socketConnectionService.startService(user.mPrivateKey);
    ...
    public void start(View view, SurfaceViewRenderer remoteVideoView) {
